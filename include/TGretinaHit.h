...
public:
  ...
  Float_t GetZerothInteractionEnergy() const { return fZerothInteractionEnergy; }
  TVector3 GetZerothInteractionPosition() const { return fZerothInteractionPosition; }
...
private:
  ...
  Float_t   fZerothInteractionEnergy;   // LR
  TVector3  fZerothInteractionPosition; // LR
